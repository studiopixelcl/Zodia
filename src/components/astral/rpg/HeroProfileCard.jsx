...
export function HeroProfileCard({ hero, onOpenInventory, onOpenSkillTree, onOpenPetSanctuary }) {
  ...
  return (
    <div className="glass-panel p-5 relative overflow-hidden bg-gradient-to-b from-black/80 via-purple-950/20 to-black/90 border border-white/10 rounded-2xl shadow-2xl">
      ...
      {/* Grid responsivo: 1 columna en móvil, 2 columnas balanceadas en Desktop (lg) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 relative z-10">
        
        {/* COLUMNA IZQUIERDA (lg:col-span-5): IDENTIDAD, RECURSOS Y MASCOTA */}
        <div className="lg:col-span-5 flex flex-col justify-between space-y-3">
          ...
          <div 
            ...
            className="p-2.5 rounded-xl bg-gradient-to-r from-purple-950/40 via-purple-900/20 to-black/60 border border-purple-500/30 hover:border-purple-400/60 cursor-pointer transition-all flex items-center justify-between group shadow-sm"
          >
        ...
        {/* COLUMNA DERECHA (lg:col-span-7): ESTADÍSTICAS, EQUIPO Y HABILIDADES */}
        <div className="lg:col-span-7 flex flex-col justify-between space-y-3 lg:border-l lg:border-white/10 lg:pl-5">
          
          {/* Cuadrícula de Estadísticas de Batalla (Dividido en Físico y Mágico) */}
          <div className="p-2 sm:p-2.5 rounded-xl bg-black/50 border border-white/10 space-y-2">
